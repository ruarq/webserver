...
void http_header_set_n(http_header_t *header, char const *key, size_t const key_n, char const *value,
...
void http_header_key_set_n(http_header_t *header, char const *key, size_t const n) {
	assert(header && key);
...
void http_header_value_set_n(http_header_t *header, char const *value, size_t const n) {
	assert(header && value);
